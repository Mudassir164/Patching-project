...
export const selectOptions = ["Embossed", "Embossed Burn", "Embossed Printed"];
export const selectOptions2 = ["Iron On ", "Velcro", "Peel And Stick"];
...
export const validationSchema = Yup.object({
  ...
  Service:
    ...
    Yup.string()
      ...
      .oneOf(selectOptions, "Please Select a Type"),
  type:
    selectOptions2 &&
    Yup.string()
      .required("Please select a Type")
      .oneOf(selectOptions2, "Please Select a Type"),
