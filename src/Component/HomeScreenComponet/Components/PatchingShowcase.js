...
const PatchingShowcase = () => {
  ...
  return (
    <div className="hidden md:w-[100%] md:flex md:flex-row md:justify-between md:items-center bg-white py-7 ">
        ...
        <img src={gears} alt="gears" className='w-[70%] ml-10 mr-10 animation-3'/>
        </div>
